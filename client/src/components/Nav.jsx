...
const toggleMenu = () => {
  ...
  return (
    <section className="fixed z-[1001] w-screen   flex flex-row justify-center items-center py-5 text-white">
      <div style={{ borderRadius: isOpen ? "0.25rem 0.25rem 0 0" : "0.25rem" }} className="w-100 z-10  flex flex-row justify-between  border-white items-center px-2 py-1 dark:bg-white/10  bg-white/70 backdrop-blur-lg ">
        {
